...
#include "../layout_g2.h"
static int
DM_LAYOUT_G2_ZONE_FIRST_CYLINDER_NUMBER_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_FIRST_CYLINDER_NUMBER_loader (struct dm_layout_g2_zone
						*result, int i)
{
  if (!(i >= 0))
    {				// foo 
...
static int
DM_LAYOUT_G2_ZONE_LAST_CYLINDER_NUMBER_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_LAST_CYLINDER_NUMBER_loader (struct dm_layout_g2_zone
					       *result, int i)
{
  if (!(i >= 0))
    {				// foo 
...
static int
DM_LAYOUT_G2_ZONE_FIRST_LBN_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_FIRST_LBN_loader (struct dm_layout_g2_zone *result, int i)
{
  if (!(i >= 0))
    {				// foo 
    }
...
static int
DM_LAYOUT_G2_ZONE_LAST_LBN_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_LAST_LBN_loader (struct dm_layout_g2_zone *result, int i)
{
  if (!(i >= 0))
    {				// foo 
    }
...
static int
DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK_loader (struct dm_layout_g2_zone *result,
					   int i)
{
  if (!(i > 0))
    {				// foo 
...
static int
DM_LAYOUT_G2_ZONE_ZONE_SKEW_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK))
    {
      return DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK;
    }
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_ZONE_SKEW_loader (struct dm_layout_g2_zone *result,
				    double d)
{
  {
...
static int
DM_LAYOUT_G2_ZONE_SKEW_UNITS_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONE_SKEW_UNITS_loader (struct dm_layout_g2_zone *result,
				     char *s)
{
...
static int
DM_LAYOUT_G2_ZONE_SKEW_FOR_TRACK_SWITCH_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK))
    {
      return DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK;
...
static void
DM_LAYOUT_G2_ZONE_SKEW_FOR_TRACK_SWITCH_loader (struct dm_layout_g2_zone
						*result, double d)
{
  {
    switch (result->skew_units)
...
static int
DM_LAYOUT_G2_ZONE_SKEW_FOR_CYLINDER_SWITCH_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK))
    {
      return DM_LAYOUT_G2_ZONE_BLOCKS_PER_TRACK;
...
static void
DM_LAYOUT_G2_ZONE_SKEW_FOR_CYLINDER_SWITCH_loader (struct dm_layout_g2_zone
						   *result, double d)
{
  {
    switch (result->skew_units)
