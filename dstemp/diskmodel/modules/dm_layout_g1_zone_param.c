...
#include "../layout_g1.h"
static int
DM_LAYOUT_G1_ZONE_FIRST_CYLINDER_NUMBER_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_FIRST_CYLINDER_NUMBER_loader (struct dm_layout_g1_band
						*result, int i)
{
  if (!(i >= 0))
    {				// foo 
...
static int
DM_LAYOUT_G1_ZONE_LAST_CYLINDER_NUMBER_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_LAST_CYLINDER_NUMBER_loader (struct dm_layout_g1_band
					       *result, int i)
{
  if (!(i >= 0))
    {				// foo 
...
static int
DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK_loader (struct dm_layout_g1_band *result,
					   int i)
{
  if (!(i > 0))
    {				// foo 
...
static int
DM_LAYOUT_G1_ZONE_OFFSET_OF_FIRST_BLOCK_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK))
    {
      return DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK;
    }
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_OFFSET_OF_FIRST_BLOCK_loader (struct dm_layout_g1_band
						*result, double d)
{
  {
...
static int
DM_LAYOUT_G1_ZONE_SKEW_UNITS_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_SKEW_UNITS_loader (struct dm_layout_g1_band *result,
				     char *s)
{
  if (!strcmp (s, "revolutions"))
    {
      result->skew_units = DM_SU_REVOLUTIONS;
    }
  else if (!strcmp (s, "sectors"))
    {
      result->skew_units = DM_SU_SECTORS;
    }
  else
    {
      ddbg_assert (0);
...
static int
DM_LAYOUT_G1_ZONE_EMPTY_SPACE_AT_ZONE_FRONT_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_EMPTY_SPACE_AT_ZONE_FRONT_loader (struct dm_layout_g1_band
						    *result, int i)
{
  result->deadspace = i;
...
static int
DM_LAYOUT_G1_ZONE_SKEW_FOR_TRACK_SWITCH_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK))
    {
      return DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK;
...
static void
DM_LAYOUT_G1_ZONE_SKEW_FOR_TRACK_SWITCH_loader (struct dm_layout_g1_band
						*result, double d)
{
  {
    switch (result->skew_units)
...
static int
DM_LAYOUT_G1_ZONE_SKEW_FOR_CYLINDER_SWITCH_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK))
    {
      return DM_LAYOUT_G1_ZONE_BLOCKS_PER_TRACK;
...
static void
DM_LAYOUT_G1_ZONE_SKEW_FOR_CYLINDER_SWITCH_loader (struct dm_layout_g1_band
						   *result, double d)
{
  {
    switch (result->skew_units)
...
static int
DM_LAYOUT_G1_ZONE_NUMBER_OF_SPARES_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_NUMBER_OF_SPARES_loader (struct dm_layout_g1_band *result,
					   int i)
{
  result->sparecnt = i;
...
static int
DM_LAYOUT_G1_ZONE_SLIPS_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_SLIPS_loader (struct dm_layout_g1_band *result,
				struct lp_list *l)
{
...
static int
DM_LAYOUT_G1_ZONE_DEFECTS_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G1_ZONE_DEFECTS_loader (struct dm_layout_g1_band *result,
				  struct lp_list *l)
{
