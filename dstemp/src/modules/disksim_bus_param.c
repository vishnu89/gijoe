...
static int
DISKSIM_BUS_TYPE_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_BUS_TYPE_loader (struct bus *result, int i)
{
  if (!(RANGE (i, 1, 2)))
    {				// foo 
    }
...
static int
DISKSIM_BUS_ARBITRATION_TYPE_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_BUS_ARBITRATION_TYPE_loader (struct bus *result, int i)
{
  if (!(RANGE (i, 1, 2)))
    {				// foo 
    }
...
static int
DISKSIM_BUS_ARBITRATION_TIME_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_BUS_ARBITRATION_TIME_loader (struct bus *result, double d)
{
  if (!((d >= 0.0)))
    {				// foo 
    }
...
static int
DISKSIM_BUS_READ_BLOCK_TRANSFER_TIME_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_BUS_READ_BLOCK_TRANSFER_TIME_loader (struct bus *result, double d)
{
  if (!((d >= 0.0)))
    {				// foo 
    }
...
static int
DISKSIM_BUS_WRITE_BLOCK_TRANSFER_TIME_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_BUS_WRITE_BLOCK_TRANSFER_TIME_loader (struct bus *result, double d)
{
  if (!((d >= 0.0)))
    {				// foo 
    }
...
static int
DISKSIM_BUS_PRINT_STATS_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_BUS_PRINT_STATS_loader (struct bus *result, int i)
{
  result->printstats = i;
