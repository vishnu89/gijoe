...
static int
DM_MECH_G1_ACCESS_TIME_TYPE_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_ACCESS_TIME_TYPE_loader (struct dm_mech_g1 *result, char *s)
{
...
static int
DM_MECH_G1_CONSTANT_ACCESS_TIME_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_CONSTANT_ACCESS_TIME_loader (struct dm_mech_g1 *result, double d)
{
  if (!(d >= 0.0))
    {				// foo 
    }
...
static int
DM_MECH_G1_SEEK_TYPE_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_SEEK_TYPE_loader (struct dm_mech_g1 *result, char *s)
{
  if (!strcmp (s, "constant"))
    {
...
static int
DM_MECH_G1_AVERAGE_SEEK_TIME_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_AVERAGE_SEEK_TIME_loader (struct dm_mech_g1 *result, double d)
{
  if (!(d >= 0.0))
    {				// foo 
    }
...
static int
DM_MECH_G1_CONSTANT_SEEK_TIME_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_CONSTANT_SEEK_TIME_loader (struct dm_mech_g1 *result, double d)
{
  if (!(d >= 0.0))
    {				// foo 
    }
...
static int
DM_MECH_G1_SINGLE_CYLINDER_SEEK_TIME_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_SINGLE_CYLINDER_SEEK_TIME_loader (struct dm_mech_g1 *result,
					     double d)
{
  if (!(d >= 0.0))
    {				// foo 
...
static int
DM_MECH_G1_FULL_STROBE_SEEK_TIME_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_FULL_STROBE_SEEK_TIME_loader (struct dm_mech_g1 *result, double d)
{
  if (!(d >= 0.0))
    {				// foo 
    }
...
static int
DM_MECH_G1_FULL_SEEK_CURVE_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_MECH_G1_SEEK_TYPE))
    {
      return DM_MECH_G1_SEEK_TYPE;
    }
  return -1;
}

static void
DM_MECH_G1_FULL_SEEK_CURVE_loader (struct dm_mech_g1 *result, char *s)
{
  result->seektime = SEEK_EXTRACTED;
...
static int
DM_MECH_G1_ADD_WRITE_SETTLING_DELAY_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_ADD_WRITE_SETTLING_DELAY_loader (struct dm_mech_g1 *result,
					    double d)
{
...
static int
DM_MECH_G1_HEAD_SWITCH_TIME_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_HEAD_SWITCH_TIME_loader (struct dm_mech_g1 *result, double d)
{
  if (!(d >= 0.0))
    {				// foo 
    }
...
static int
DM_MECH_G1_ROTATION_SPEED__depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_ROTATION_SPEED__loader (struct dm_mech_g1 *result, int i)
{
  if (!(i > 0))
    {				// foo 
    }
...
static int
DM_MECH_G1_PERCENT_ERROR_IN_RPMS_depend (char *bv)
{
  return -1;
}

static void
DM_MECH_G1_PERCENT_ERROR_IN_RPMS_loader (struct dm_mech_g1 *result, double d)
{
...
static int
DM_MECH_G1_FIRST_TEN_SEEK_TIMES_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_MECH_G1_SEEK_TYPE))
    {
      return DM_MECH_G1_SEEK_TYPE;
...
static void
DM_MECH_G1_FIRST_TEN_SEEK_TIMES_loader (struct dm_mech_g1 *result,
					struct lp_list *l)
{
...
static int
DM_MECH_G1_HPL_SEEK_EQUATION_VALUES_depend (char *bv)
{
  if (!BIT_TEST (bv, DM_MECH_G1_SEEK_TYPE))
    {
      return DM_MECH_G1_SEEK_TYPE;
...
static void
DM_MECH_G1_HPL_SEEK_EQUATION_VALUES_loader (struct dm_mech_g1 *result,
					    struct lp_list *l)
{
