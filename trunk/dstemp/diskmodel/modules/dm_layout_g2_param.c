...
#include "../layout_g2.h"
static int
DM_LAYOUT_G2_LAYOUT_MAP_FILE_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_LAYOUT_MAP_FILE_loader (struct dm_layout_g2 *result, char *s)
{
...
static int
DM_LAYOUT_G2_ZONES_depend (char *bv)
{
  return -1;
}

static void
DM_LAYOUT_G2_ZONES_loader (struct dm_layout_g2 *result, struct lp_list *l)
{
