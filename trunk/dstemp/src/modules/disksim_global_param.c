...
static int
DISKSIM_GLOBAL_INIT_SEED_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_INIT_SEED_loader (int result, int i)
{
  disksim->seedval = i;
...
static int
DISKSIM_GLOBAL_INIT_SEED_WITH_TIME_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_INIT_SEED_WITH_TIME_loader (int result, int i)
{
  if (!(RANGE (i, 0, 1)))
    {				// foo 
    }
...
static int
DISKSIM_GLOBAL_REAL_SEED_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_REAL_SEED_loader (int result, int i)
{
  disksim->seedval = i;
...
static int
DISKSIM_GLOBAL_REAL_SEED_WITH_TIME_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_REAL_SEED_WITH_TIME_loader (int result, int i)
{
  if (!(RANGE (i, 0, 1)))
    {				// foo 
    }
...
static int
DISKSIM_GLOBAL_STATISTIC_WARM_UP_TIME_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_STATISTIC_WARM_UP_TIME_loader (int result, double d)
{
  if (!((d >= 0)))
    {				// foo 
    }
...
static int
DISKSIM_GLOBAL_STATISTIC_WARM_UP_IOS_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_STATISTIC_WARM_UP_IOS_loader (int result, int i)
{
  if (!((i >= 0)))
    {				// foo 
    }
...
static int
DISKSIM_GLOBAL_STAT_DEFINITION_FILE_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_STAT_DEFINITION_FILE_loader (int result, char *s)
{
...
static int
DISKSIM_GLOBAL_OUTPUT_FILE_FOR_TRACE_OF_IO_REQUESTS_SIMULATED_depend (char
								      *bv)
{
  return -1;
}
...
static void
DISKSIM_GLOBAL_OUTPUT_FILE_FOR_TRACE_OF_IO_REQUESTS_SIMULATED_loader (int
								      result,
								      char *s)
{
  if (!((outios = fopen (s, "w")) != NULL))
    {				// foo 
    }
...
static int
DISKSIM_GLOBAL_DETAILED_EXECUTION_TRACE_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_GLOBAL_DETAILED_EXECUTION_TRACE_loader (int result, char *s)
{
  if (!((disksim->exectrace = fopen (s, "w")) != NULL))
    {				// foo 
    }
...
void *DISKSIM_GLOBAL_loaders[] = {
  ...
  (void *)
    DISKSIM_GLOBAL_OUTPUT_FILE_FOR_TRACE_OF_IO_REQUESTS_SIMULATED_loader,
