...
static int
DISKSIM_PF_STATS_PRINT_PER_PROCESS_STATS_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_PF_STATS_PRINT_PER_PROCESS_STATS_loader (int result, int i)
{
  if (!(RANGE (i, 0, 1)))
    {				// foo 
    }
...
static int
DISKSIM_PF_STATS_PRINT_PER_CPU_STATS_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_PF_STATS_PRINT_PER_CPU_STATS_loader (int result, int i)
{
  if (!(RANGE (i, 0, 1)))
    {				// foo 
    }
...
static int
DISKSIM_PF_STATS_PRINT_ALL_INTERRUPT_STATS_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_PF_STATS_PRINT_ALL_INTERRUPT_STATS_loader (int result, int i)
{
  if (!(RANGE (i, 0, 1)))
    {				// foo 
    }
...
static int
DISKSIM_PF_STATS_PRINT_SLEEP_STATS_depend (char *bv)
{
  return -1;
}

static void
DISKSIM_PF_STATS_PRINT_SLEEP_STATS_loader (int result, int i)
{
  if (!(RANGE (i, 0, 1)))
    {				// foo 
    }
